...
[GCF calculator](https://www.hackmath.net/en/calculator/greatest-common-divisor?input=54%2C+12&submit=Calculate+GCD)
...
<a href="https://www.codecogs.com/eqnedit.php?latex=2.8&space;=&space;2\frac{8}{10}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?2.8&space;=&space;2\frac{8}{10}" title="2.8 = 2\frac{8}{10}" /></a>
...
This property states that `a^-1` is the reciprocal of `a`. In other words, `a^-1` means 'invert a'. 
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{x(x-6)}{2x}=\frac{x-6}{2}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{x(x-6)}{2x}=\frac{x-6}{2}" title="\frac{x(x-6)}{2x}=\frac{x-6}{2}" /></a>
...
<h3>Working with Non Perfect Squares</h3>
...
Constants are terms with no variables.
...
Sometimes you can combine two or more terms at a time in such a way each term has an algebraic expression as a common factor.
...
Using all the steps outlined above, lets take a look at some more examples.

<h3>Difference of Squares</h3>

Quadratic polynomials in the form <a href="https://www.codecogs.com/eqnedit.php?latex=x^2-c^2" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x^2-c^2" title="x^2-c^2" /></a> are called the **difference of squares**. 

When the sign between `x^2` and `c^2` is a *plus*, the **quadratic cannot be factored using real numbers**!  

<a href="https://www.codecogs.com/eqnedit.php?latex=\newline&space;x^2-4=(x&plus;2)(x-2)&space;\newline&space;x^2-81=(x&plus;9)(x-9)&space;\newline&space;x^2-25=(x&plus;5)(x-5)&space;\newline&space;x^2-64=(x&plus;8)(x-8)&space;\newline&space;x^2-15=(x&plus;\sqrt{15})(x-\sqrt{15})&space;\newline&space;25-x^2=(5-x)(5&plus;x)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\newline&space;x^2-4=(x&plus;2)(x-2)&space;\newline&space;x^2-81=(x&plus;9)(x-9)&space;\newline&space;x^2-25=(x&plus;5)(x-5)&space;\newline&space;x^2-64=(x&plus;8)(x-8)&space;\newline&space;x^2-15=(x&plus;\sqrt{15})(x-\sqrt{15})&space;\newline&space;25-x^2=(5-x)(5&plus;x)" title="\newline x^2-4=(x+2)(x-2) \newline x^2-81=(x+9)(x-9) \newline x^2-25=(x+5)(x-5) \newline x^2-64=(x+8)(x-8) \newline x^2-15=(x+\sqrt{15})(x-\sqrt{15}) \newline 25-x^2=(5-x)(5+x)" /></a>

<h3>! Difference Of Squares pt II</h3>
The difference of squares can come in the form <a href="https://www.codecogs.com/eqnedit.php?latex=x^n-c^n" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x^n-c^n" title="x^n-c^n" /></a> where `n` is any even number. The factorization is:

![f](https://imgur.com/0FdPUNo.png)

<a href="https://www.codecogs.com/eqnedit.php?latex=x^n-c^n=\big(x^{\frac{n}{2}}-c^{\frac{n}{2}}\big)\big(x^\frac{n}{2}&plus;c^{\frac{n}{2}}\big)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x^n-c^n=\big(x^{\frac{n}{2}}-c^{\frac{n}{2}}\big)\big(x^\frac{n}{2}&plus;c^{\frac{n}{2}}\big)" title="x^n-c^n=\big(x^{\frac{n}{2}}-c^{\frac{n}{2}}\big)\big(x^\frac{n}{2}+c^{\frac{n}{2}}\big)" /></a>


Remember: `1` raised to any exponent is always equal to `1.`
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\newline&space;x^{12}=x^{12}-1^{12}&space;\newline&space;=(x^6-1)(x&plus;1^6)&space;\newline&space;=(x^6&plus;1)(x^3-1)(x^3&plus;1)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\newline&space;x^{12}=x^{12}-1^{12}&space;\newline&space;=(x^6-1)(x&plus;1^6)&space;\newline&space;=(x^6&plus;1)(x^3-1)(x^3&plus;1)" title="\newline x^{12}=x^{12}-1^{12} \newline =(x^6-1)(x+1^6) \newline =(x^6+1)(x^3-1)(x^3+1)" /></a>

![f](https://imgur.com/uMXyY3N.png)

<h3>Qaudatic Polynomials that don't Factor Nicely</h3>

The coeffecient of the `x^2` term will not always factor away nicely. In order to factor quadratics such as the examples below you will need to try *all* combinations for the factors  for `ax^2` and `c` in `ax^2+bx+c` 

For the problem:

<a href="https://www.codecogs.com/eqnedit.php?latex=4x^2-4x-15" target="_blank"><img src="https://latex.codecogs.com/gif.latex?4x^2-4x-15" title="4x^2-4x-15" /></a>

These are all possible factor combinations:

<a href="https://www.codecogs.com/eqnedit.php?latex=\newline&space;(4x&plus;15)(x-1)&space;\newline&space;(4x-1)(x&plus;15)&space;\newline&space;(4x&plus;5)(x-3)&space;\newline&space;(4x&plus;3)(x-5)&space;\newline&space;(2x&plus;15)(2x-1)&space;\newline&space;(2x&plus;5)(2x-3)&space;\newline&space;(4x-15)(x&plus;1)&space;\newline&space;(4x&plus;1)(x-15)&space;\newline&space;(4x-5)(x&plus;3)&space;\newline&space;(4x-3)(x&plus;5)&space;\newline&space;(2x-15)(2x&plus;1)&space;\newline&space;(2x-5)(2x&plus;3)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\newline&space;(4x&plus;15)(x-1)&space;\newline&space;(4x-1)(x&plus;15)&space;\newline&space;(4x&plus;5)(x-3)&space;\newline&space;(4x&plus;3)(x-5)&space;\newline&space;(2x&plus;15)(2x-1)&space;\newline&space;(2x&plus;5)(2x-3)&space;\newline&space;(4x-15)(x&plus;1)&space;\newline&space;(4x&plus;1)(x-15)&space;\newline&space;(4x-5)(x&plus;3)&space;\newline&space;(4x-3)(x&plus;5)&space;\newline&space;(2x-15)(2x&plus;1)&space;\newline&space;(2x-5)(2x&plus;3)" title="\newline (4x+15)(x-1) \newline (4x-1)(x+15) \newline (4x+5)(x-3) \newline (4x+3)(x-5) \newline (2x+15)(2x-1) \newline (2x+5)(2x-3) \newline (4x-15)(x+1) \newline (4x+1)(x-15) \newline (4x-5)(x+3) \newline (4x-3)(x+5) \newline (2x-15)(2x+1) \newline (2x-5)(2x+3)" /></a>

The correct combination is `(2x-5)(2x+3)`

<h3>Quadratic Type Expressions</h3>

An expression with three terms where the power of the first term is *twice* that of the second, and the third term is a constant is called a *quadratic type expression*.

They factor the same way as quadratic polynomials. The power on `x` in the factorization will be the power on `x` in the middle term. 

Examples:

<a href="https://www.codecogs.com/eqnedit.php?latex=\newline&space;x^4-2x^2-3&space;=&space;(x^2-3)(x^2&plus;1)&space;\newline&space;x^6-2x^3-3&space;=&space;(x^3-3)(x^3&plus;1)&space;\newline&space;4x^6&plus;20x^3&plus;21&space;=&space;(2x^3&plus;7)(2x^3&plus;3)&space;\newline&space;x^{\frac{2}{3}}-5x^\frac{1}{3}&plus;6=(x^\frac{1}{3}-2)(x^\frac{1}{3}-3)&space;\newline&space;\newline&space;\newline" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\newline&space;x^4-2x^2-3&space;=&space;(x^2-3)(x^2&plus;1)&space;\newline&space;x^6-2x^3-3&space;=&space;(x^3-3)(x^3&plus;1)&space;\newline&space;4x^6&plus;20x^3&plus;21&space;=&space;(2x^3&plus;7)(2x^3&plus;3)&space;\newline&space;x^{\frac{2}{3}}-5x^\frac{1}{3}&plus;6=(x^\frac{1}{3}-2)(x^\frac{1}{3}-3)&space;\newline&space;\newline&space;\newline" title="\newline x^4-2x^2-3 = (x^2-3)(x^2+1) \newline x^6-2x^3-3 = (x^3-3)(x^3+1) \newline 4x^6+20x^3+21 = (2x^3+7)(2x^3+3) \newline x^{\frac{2}{3}}-5x^\frac{1}{3}+6=(x^\frac{1}{3}-2)(x^\frac{1}{3}-3) \newline \newline \newline" /></a>

![f](https://imgur.com/DpuZwNA.png)

![f](https://imgur.com/ThvSpv4.png)
...
What it means to 'solve for x' is to isolate x on one side of the equation and to move everything else on the other side. 

Not every equation will have a solution. For example `x+3=x+10` has no solution. Why? There is no number that can be added to three and be the same quantity as when it was added to 10. If you were to try and solve for `x` you would get the false statement `3=10`. 

In order to solve for a variable correctly you must know the order of operations. 
